// Generated from d:/Documents/Hiast/FourthYear/SecondSemester/Compilers/theoretical/Arabic_Compiler/Grammar/ArabicHtmlLexer.g4 by ANTLR 4.13.1
...
public class ArabicHtmlLexer extends ArabicLexerBase {
	...
	public static final int
		CSS_OPEN=1, CSS_CLOSE=2, JS_OPEN=3, JS_CLOSE=4, CLOSE_TAG=5, OPEN_TAG=6, 
		SELF_CLOSE=7, TEXT=8, HTML_WS=9, CSS_CLOSE_TAG=10, CSS_WS=11, CSS_COMMENT=12, 
		CSS_DISPLAY=13, CSS_POSITION=14, CSS_WIDTH=15, CSS_HEIGHT=16, CSS_MAX_WIDTH=17, 
		CSS_MIN_WIDTH=18, CSS_MAX_HEIGHT=19, CSS_MIN_HEIGHT=20, CSS_MARGIN=21, 
		CSS_PADDING=22, CSS_BORDER=23, CSS_VISIBILITY=24, CSS_OVERFLOW=25, CSS_Z_INDEX=26, 
		CSS_BOX_SIZING=27, CSS_FLEX=28, CSS_FLEX_DIR=29, CSS_FLEX_WRAP=30, CSS_FLEX_GROW=31, 
		CSS_FLEX_SHRINK=32, CSS_GRID=33, CSS_GRID_TEMPLATE=34, CSS_GAP=35, CSS_JUSTIFY_CONT=36, 
		CSS_ALIGN_ITEMS=37, CSS_ALIGN_SELF=38, CSS_ORDER=39, CSS_COLOR=40, CSS_BACKGROUND=41, 
		CSS_BG_IMAGE=42, CSS_BG_COLOR=43, CSS_BG_SIZE=44, CSS_BG_REPEAT=45, CSS_BG_ATTACH=46, 
		CSS_BG_CLIP=47, CSS_OPACITY=48, CSS_BOX_SHADOW=49, CSS_FONT_FAMILY=50, 
		CSS_FONT_SIZE=51, CSS_FONT_WEIGHT=52, CSS_FONT_STYLE=53, CSS_TEXT_ALIGN=54, 
		CSS_TEXT_DECOR=55, CSS_TEXT_TRANS=56, CSS_TEXT_SHADOW=57, CSS_TEXT_INDENT=58, 
		CSS_LINE_HEIGHT=59, CSS_LETTER_SPACING=60, CSS_WORD_SPACING=61, CSS_WHITE_SPACE=62, 
		CSS_DIRECTION=63, CSS_WRITING_MODE=64, CSS_BORDER_RADIUS=65, CSS_BORDER_WIDTH=66, 
		CSS_BORDER_STYLE=67, CSS_BORDER_COLOR=68, CSS_OUTLINE=69, CSS_TOP=70, 
		CSS_BOTTOM=71, CSS_RIGHT=72, CSS_LEFT=73, CSS_MEDIA=74, CSS_LIST_STYLE=75, 
		CSS_BORDER_COLLAPSE=76, CSS_TABLE_LAYOUT=77, CSS_CAPTION_SIDE=78, CSS_FILTER=79, 
		CSS_BACKDROP_FILT=80, CSS_HOVER=81, CSS_ACTIVE=82, CSS_FOCUS=83, CSS_VISITED=84, 
		CSS_ENABLED=85, CSS_DISABLED=86, CSS_CHECKED=87, CSS_BEFORE=88, CSS_AFTER=89, 
		CSS_PLACEHOLDER=90, CSS_SELECTION=91, CSS_INHERIT=92, CSS_INITIAL=93, 
		CSS_UNSET=94, CSS_NONE=95, CSS_AUTO=96, CSS_CENTER=97, CSS_SOLID=98, CSS_DASHED=99, 
		CSS_DOTTED=100, CSS_DOUBLE=101, CSS_HIDDEN=102, CSS_BLOCK=103, CSS_INLINE=104, 
		CSS_FLEX_VALUE=105, CSS_ABSOLUTE=106, CSS_RELATIVE=107, CSS_FIXED=108, 
		CSS_STICKY=109, CSS_ROW=110, CSS_COLUMN=111, CSS_WRAP=112, CSS_POINTER=113, 
		CSS_BOLD=114, CSS_ITALIC=115, CSS_IMPORTANT=116, CSS_URL_FUNC=117, CSS_RGB_FUNC=118, 
		CSS_RGBA_FUNC=119, CSS_CALC_FUNC=120, CSS_VAR_FUNC=121, CSS_ROTATE_FUNC=122, 
		CSS_SCALE_FUNC=123, CSS_BLUR_FUNC=124, CSS_UNIT=125, CSS_HEX_COLOR=126, 
		CSS_NUMBER=127, CSS_STRING=128, CSS_LBRACE=129, CSS_RBRACE=130, CSS_COLON=131, 
		CSS_SEMI=132, CSS_COMMA=133, CSS_DOT=134, CSS_HASH=135, CSS_LPAREN=136, 
		CSS_RPAREN=137, CSS_GT=138, CSS_TILDE=139, CSS_DBL_COLON=140, CSS_IDENTIFIER=141, 
		JS_CLOSE_TAG=142, JS_WS=143, JS_COMMENT=144, JS_LINE_COMMENT=145, JS_VAR=146, 
		JS_LET=147, JS_CONST=148, JS_ARRAY_KW=149, JS_STRING_KW=150, JS_NUMBER_KW=151, 
		JS_BOOLEAN_KW=152, JS_SYMBOL_KW=153, JS_MAP_KW=154, JS_SET_KW=155, JS_DATE_KW=156, 
		JS_OBJECT_KW=157, JS_IF=158, JS_ELSE=159, JS_SWITCH=160, JS_CASE=161, 
		JS_DEFAULT=162, JS_FOR=163, JS_WHILE=164, JS_DO=165, JS_BREAK=166, JS_CONTINUE=167, 
		JS_OF=168, JS_IN=169, JS_FUNCTION=170, JS_RETURN=171, JS_TRUE=172, JS_FALSE=173, 
		JS_NULL=174, JS_UNDEFINED=175, JS_THIS=176, JS_NAN=177, JS_INFINITY=178, 
		JS_TRY=179, JS_CATCH=180, JS_FINALLY=181, JS_THROW=182, JS_EXCEPTION=183, 
		JS_NEW=184, JS_CLASS=185, JS_EXTENDS=186, JS_SUPER=187, JS_IMPLEMENTS=188, 
		JS_INTERFACE=189, JS_CONSTRUCTOR=190, JS_PRIVATE=191, JS_PROTECTED=192, 
		JS_PUBLIC=193, JS_STATIC=194, JS_ENUM=195, JS_PACKAGE=196, JS_IMPORT=197, 
		JS_EXPORT=198, JS_FROM=199, JS_AS=200, JS_TYPEOF=201, JS_INSTANCEOF=202, 
		JS_DELETE=203, JS_DOCUMENT=204, JS_WINDOW=205, JS_CONSOLE=206, JS_EVENT=207, 
		JS_NODE=208, JS_ELEMENT=209, JS_LISTENER=210, JS_LOCAL_STORAGE=211, JS_SESSION_STORAGE=212, 
		JS_GET_ELEMENT=213, JS_GET_ELEMENTS=214, JS_CREATE_EL=215, JS_INNER_TEXT=216, 
		JS_INNER_HTML=217, JS_STYLE=218, JS_ADD_LISTENER=219, JS_ON_CLICK=220, 
		JS_ON_SUBMIT=221, JS_ON_CHANGE=222, JS_ON_LOAD=223, JS_LOG=224, JS_ALERT=225, 
		JS_PROMPT=226, JS_INC=227, JS_DEC=228, JS_EXP=229, JS_EXP_ASSIGN=230, 
		JS_ADD_ASSIGN=231, JS_SUB_ASSIGN=232, JS_MUL_ASSIGN=233, JS_DIV_ASSIGN=234, 
		JS_MOD_ASSIGN=235, JS_AND_ASSIGN=236, JS_OR_ASSIGN=237, JS_NULL_ASSIGN=238, 
		JS_ASSIGN=239, JS_STREQ=240, JS_STRNEQ=241, JS_EQ=242, JS_NEQ=243, JS_GTE=244, 
		JS_LTE=245, JS_AND=246, JS_OR=247, JS_NULL_COAL=248, JS_URSH=249, JS_LSH=250, 
		JS_RSH=251, JS_BIT_AND=252, JS_BIT_OR=253, JS_BIT_XOR=254, JS_QUESTION=255, 
		JS_ARROW=256, JS_SPREAD=257, JS_NUMBER=258, JS_STRING=259, JS_LBRACE=260, 
		JS_RBRACE=261, JS_LPAREN=262, JS_RPAREN=263, JS_LBRACK=264, JS_RBRACK=265, 
		JS_SEMI=266, JS_COMMA=267, JS_DOT=268, JS_COLON=269, JS_PLUS=270, JS_MINUS=271, 
		JS_STAR=272, JS_SLASH=273, JS_PERCENT=274, JS_LT=275, JS_GT=276, JS_BANG=277, 
		JS_IDENTIFIER=278;
	public static final int
		CSS_MODE=1, JS_MODE=2;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "CSS_MODE", "JS_MODE"
	};

	private static String[] makeRuleNames() {
		return new String[] {
			"ARABIC_CHAR", "ARABIC_WORD", "CSS_OPEN", "CSS_CLOSE", "JS_OPEN", "JS_CLOSE", 
			"CLOSE_TAG", "OPEN_TAG", "SELF_CLOSE", "TEXT", "HTML_WS", "CSS_CLOSE_TAG", 
			"CSS_WS", "CSS_COMMENT", "CSS_DISPLAY", "CSS_POSITION", "CSS_WIDTH", 
			...
			"CSS_ROTATE_FUNC", "CSS_SCALE_FUNC", "CSS_BLUR_FUNC", "CSS_UNIT", "CSS_HEX_COLOR", 
			"CSS_NUMBER", "CSS_STRING", "CSS_LBRACE", "CSS_RBRACE", "CSS_COLON", 
			"CSS_SEMI", "CSS_COMMA", "CSS_DOT", "CSS_HASH", "CSS_LPAREN", "CSS_RPAREN", 
			"CSS_GT", "CSS_TILDE", "CSS_DBL_COLON", "CSS_IDENTIFIER", "JS_CLOSE_TAG", 
			"JS_WS", "JS_COMMENT", "JS_LINE_COMMENT", "JS_VAR", "JS_LET", "JS_CONST", 
			"JS_ARRAY_KW", "JS_STRING_KW", "JS_NUMBER_KW", "JS_BOOLEAN_KW", "JS_SYMBOL_KW", 
			"JS_MAP_KW", "JS_SET_KW", "JS_DATE_KW", "JS_OBJECT_KW", "JS_IF", "JS_ELSE", 
			"JS_SWITCH", "JS_CASE", "JS_DEFAULT", "JS_FOR", "JS_WHILE", "JS_DO", 
			"JS_BREAK", "JS_CONTINUE", "JS_OF", "JS_IN", "JS_FUNCTION", "JS_RETURN", 
			"JS_TRUE", "JS_FALSE", "JS_NULL", "JS_UNDEFINED", "JS_THIS", "JS_NAN", 
			"JS_INFINITY", "JS_TRY", "JS_CATCH", "JS_FINALLY", "JS_THROW", "JS_EXCEPTION", 
			"JS_NEW", "JS_CLASS", "JS_EXTENDS", "JS_SUPER", "JS_IMPLEMENTS", "JS_INTERFACE", 
			"JS_CONSTRUCTOR", "JS_PRIVATE", "JS_PROTECTED", "JS_PUBLIC", "JS_STATIC", 
			"JS_ENUM", "JS_PACKAGE", "JS_IMPORT", "JS_EXPORT", "JS_FROM", "JS_AS", 
			"JS_TYPEOF", "JS_INSTANCEOF", "JS_DELETE", "JS_DOCUMENT", "JS_WINDOW", 
			...
			"JS_INC", "JS_DEC", "JS_EXP", "JS_EXP_ASSIGN", "JS_ADD_ASSIGN", "JS_SUB_ASSIGN", 
			"JS_MUL_ASSIGN", "JS_DIV_ASSIGN", "JS_MOD_ASSIGN", "JS_AND_ASSIGN", "JS_OR_ASSIGN", 
			"JS_NULL_ASSIGN", "JS_ASSIGN", "JS_STREQ", "JS_STRNEQ", "JS_EQ", "JS_NEQ", 
			"JS_GTE", "JS_LTE", "JS_AND", "JS_OR", "JS_NULL_COAL", "JS_URSH", "JS_LSH", 
			"JS_RSH", "JS_BIT_AND", "JS_BIT_OR", "JS_BIT_XOR", "JS_QUESTION", "JS_ARROW", 
			"JS_SPREAD", "JS_NUMBER", "JS_STRING", "JS_LBRACE", "JS_RBRACE", "JS_LPAREN", 
			"JS_RPAREN", "JS_LBRACK", "JS_RBRACK", "JS_SEMI", "JS_COMMA", "JS_DOT", 
			"JS_COLON", "JS_PLUS", "JS_MINUS", "JS_STAR", "JS_SLASH", "JS_PERCENT", 
			"JS_LT", "JS_GT", "JS_BANG", "JS_IDENTIFIER"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, "'\\u0639\\u0631\\u0636'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "CSS_OPEN", "CSS_CLOSE", "JS_OPEN", "JS_CLOSE", "CLOSE_TAG", "OPEN_TAG", 
