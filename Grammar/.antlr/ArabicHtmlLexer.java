// Generated from c:/Users/ElectoMall/OneDrive/Desktop/projects/MiniProjects/compilers/Arabic_Compiler/Grammar/ArabicHtmlLexer.g4 by ANTLR 4.13.1
...
public class ArabicHtmlLexer extends ArabicLexerBase {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ARABIC_CHAR", "ARABIC_WORD", "CLOSE_TAG", "OPEN_TAG_START", "SELF_CLOSE_END", 
			"ATTR_ID", "ATTR_CLASS", "ATTR_SRC", "ATTR_HREF", "CSS_DISPLAY", "CSS_POSITION", 
			...
			"TS_ALERT", "TS_PROMPT", "IDENTIFIER", "ARABIC_DIGIT", "ANY_DIGIT", "CSS_UNIT", 
			"NUMBER", "CSS_HEX_COLOR", "TS_INC", "TS_DEC", "TS_EXP_ASSIGN", "TS_EXP", 
			"TS_ADD_ASSIGN", "TS_SUB_ASSIGN", "TS_MUL_ASSIGN", "TS_DIV_ASSIGN", "TS_MOD_ASSIGN", 
			"TS_AND_ASSIGN", "TS_OR_ASSIGN", "TS_NULL_ASSIGN", "TS_SPREAD", "TS_ARROW", 
			"TS_STREQ", "TS_STRNEQ", "TS_EQ", "TS_NEQ", "TS_GTE", "TS_LTE", "TS_AND", 
			"TS_OR", "TS_NULL_COAL", "TS_URSH", "TS_RSH", "TS_LSH", "TS_ASSIGN", 
			"TS_BIT_AND", "TS_BIT_OR", "TS_BIT_XOR", "TS_QUESTION", "LBRACE", "RBRACE", 
