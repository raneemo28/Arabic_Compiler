...
class ArabicHtmlParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ArabicHtmlParser#htmlElement.
    def enterHtmlElement(self, ctx:ArabicHtmlParser.HtmlElementContext):
        pass

    # Exit a parse tree produced by ArabicHtmlParser#htmlElement.
    def exitHtmlElement(self, ctx:ArabicHtmlParser.HtmlElementContext):
        pass
