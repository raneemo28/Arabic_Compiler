// Generated from c:/Users/Asus/Desktop/Arabic_Compiler/Lexer/ACSSLexer.g4 by ANTLR 4.13.1
...
public class ACSSLexer extends ArabicLexerBase {
	...
	public static final int
		WS=1, COMMENT=2, LBRACE=3, RBRACE=4, COLON=5, SEMI=6, COMMA=7, DOT=8, 
		HASH=9, LPAREN=10, RPAREN=11, PLUS=12, MINUS=13, STAR=14, SLASH=15, PERCENT=16, 
		GT=17, LT=18, TILDE=19, BANG=20, DBL_COLON=21, DISPLAY=22, POSITION=23, 
		WIDTH=24, HEIGHT=25, MAX_WIDTH=26, MIN_WIDTH=27, MAX_HEIGHT=28, MIN_HEIGHT=29, 
		MARGIN=30, PADDING=31, BORDER=32, VISIBILITY=33, OVERFLOW=34, Z_INDEX=35, 
		BOX_SIZING=36, FLEX=37, FLEX_DIR=38, FLEX_WRAP=39, FLEX_GROW=40, FLEX_SHRINK=41, 
		GRID=42, GRID_TEMPLATE=43, GAP=44, JUSTIFY_CONT=45, ALIGN_ITEMS=46, ALIGN_SELF=47, 
		ORDER=48, COLOR=49, BACKGROUND=50, BG_IMAGE=51, BG_COLOR=52, BG_SIZE=53, 
		BG_REPEAT=54, BG_ATTACH=55, BG_CLIP=56, OPACITY=57, BOX_SHADOW=58, FONT_FAMILY=59, 
		FONT_SIZE=60, FONT_WEIGHT=61, FONT_STYLE=62, TEXT_ALIGN=63, TEXT_DECOR=64, 
		TEXT_TRANS=65, TEXT_SHADOW=66, TEXT_INDENT=67, LINE_HEIGHT=68, LETTER_SPACING=69, 
		WORD_SPACING=70, WHITE_SPACE=71, DIRECTION=72, WRITING_MODE=73, BORDER_RADIUS=74, 
		BORDER_WIDTH=75, BORDER_STYLE=76, BORDER_COLOR=77, OUTLINE=78, TOP=79, 
		BOTTOM=80, RIGHT=81, LEFT=82, MEDIA=83, LIST_STYLE=84, BORDER_COLLAPSE=85, 
		TABLE_LAYOUT=86, CAPTION_SIDE=87, FILTER=88, BACKDROP_FILT=89, HOVER=90, 
		ACTIVE=91, FOCUS=92, VISITED=93, ENABLED=94, DISABLED=95, CHECKED=96, 
		BEFORE=97, AFTER=98, PLACEHOLDER=99, SELECTION=100, INHERIT=101, INITIAL=102, 
		UNSET=103, NONE=104, AUTO=105, CENTER=106, SOLID=107, DASHED=108, DOTTED=109, 
		DOUBLE=110, KW_HIDDEN=111, BLOCK=112, INLINE=113, FLEX_VALUE=114, ABSOLUTE=115, 
		RELATIVE=116, FIXED=117, STICKY=118, ROW=119, COLUMN=120, WRAP=121, POINTER=122, 
		BOLD=123, ITALIC=124, IMPORTANT=125, UNIT=126, NUMBER=127, HEX_COLOR=128, 
		IDENTIFIER=129, STRING=130, URL_FUNC=131, RGB_FUNC=132, RGBA_FUNC=133, 
		CALC_FUNC=134, VAR_FUNC=135, ROTATE_FUNC=136, SCALE_FUNC=137, BLUR_FUNC=138;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"WS", "COMMENT", "LBRACE", "RBRACE", "COLON", "SEMI", "COMMA", "DOT", 
			"HASH", "LPAREN", "RPAREN", "PLUS", "MINUS", "STAR", "SLASH", "PERCENT", 
			"GT", "LT", "TILDE", "BANG", "DBL_COLON", "DISPLAY", "POSITION", "WIDTH", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"PERCENT", "GT", "LT", "TILDE", "BANG", "DBL_COLON", "DISPLAY", "POSITION", 
	...
	public ACSSLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "ACSSLexer.g4"; }
